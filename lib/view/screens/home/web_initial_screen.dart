...
class WebInitialScreen extends StatefulWidget  {

  WebInitialScreen({Key? key,}) : super(key: key);

  @override
  State<WebInitialScreen> createState() => _WebInitialScreenState();
}

class _WebInitialScreenState extends State<WebInitialScreen> with TickerProviderStateMixin {
