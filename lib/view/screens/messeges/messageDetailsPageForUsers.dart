...
class MessageDetailsPageForUser extends StatefulWidget {
 final  String? profilePic;
 final int? otherUserChatId;
 final String? userName;

  const MessageDetailsPageForUser({Key? key, this.profilePic,this.otherUserChatId, this.userName, }) : super(key: key);

  @override
  State<MessageDetailsPageForUser> createState() => _MessageDetailsPageState();
}

class _MessageDetailsPageState extends State<MessageDetailsPageForUser> {
  ...
  Widget build(BuildContext context) {
    ...
    double mediaWidth=size.width<1000?size.width:size.width*1;
    return Scaffold(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              ...
              SizedBox(width: 10,),
              Text(widget.userName.toString(), style: TextStyle(color: Colors.black, fontSize: 16, fontWeight: FontWeight.bold,)),
              SizedBox(width: 35,),
            ],
          ),
          SizedBox()
